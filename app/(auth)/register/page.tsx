    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            toast.success("Akun berhasil dibuat!", {
                description: "Silakan periksa kotak masuk email Anda untuk memverifikasi akun sebelum login."
            });
            router.push("/login");
        }
    };
        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
                <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-8 text-white text-center">
                    ...
                    <p className="mt-2 text-blue-100 text-sm">Portal CV. Surya Perkasa</p>
                </div>
                ...
                <div className="p-8">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-slate-600">
                            Sudah punya akun? <Link href="/login" className="font-medium text-blue-600 hover:text-blue-500">Masuk di sini</Link>
                        </p>
                    </div>
                </div>
            </div>
