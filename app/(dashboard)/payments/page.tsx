            ...
            <div className="grid lg:grid-cols-2 gap-5">
                ...
                <div className="bg-[#1a1c23]/60 backdrop-blur-xl p-5 rounded-xl shadow-lg border border-white/10 relative overflow-hidden">
                    ...
                    <form onSubmit={handleManualAdd} className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
                        ...
                        <button type="submit" disabled={isAddingManual} className="office-calm-contrast-text bg-emerald-600/20 border border-emerald-500/30 text-emerald-400 font-bold rounded-lg px-3 py-2 text-sm hover:bg-emerald-500/30 transition-colors disabled:opacity-50">
                            Simpan Entry
                        </button>
                    </form>
                </div>
