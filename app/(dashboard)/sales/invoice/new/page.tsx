...
import { ArrowLeft, Save, FileText, ShoppingCart, Plus, Trash2 } from "lucide-react";
...
const invoiceSchema = z.object({
    ...
    transDate: z.string().min(1, "Tanggal faktur wajib diisi"),
...
export default function NewSalesInvoice() {
    ...
    const onSubmit = async (data: InvoiceFormValues) => {
        ...
        try {
            ...
            const response = await accurateFetch("/api/sales-invoice/save.do", "POST", payload);
        ...
        <div className="flex flex-col h-full gap-6 pb-12">
            ...
            <div className="flex items-center justify-between bg-[#16181d]/80 rounded-2xl border border-white/5 shadow-2xl p-4 backdrop-blur-md sticky top-0 z-20">
                <div className="flex items-center gap-3">
                    <Link href="/sales/invoice" className="p-2 hover:bg-white/5 rounded-lg transition-colors text-slate-400 hover:text-white">
                        <ArrowLeft size={20} />
                    </Link>
                    <div className="w-px h-6 bg-white/10 mx-2"></div>
                    <div className="flex items-center gap-2">
                        <ShoppingCart size={18} className="text-indigo-400" />
                        <h1 className="text-lg font-bold text-white tracking-tight">Faktur Penjualan Baru</h1>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-sm font-medium text-slate-300">
                                    Tgl. Faktur <span className="text-red-400">*</span>
                                </label>
                                <input 
                                    type="date"
                                    {...register("transDate")}
                    ...
                    <table className="w-full text-left text-sm text-slate-400">
                        <thead className="text-xs uppercase bg-[#0a0a0c]/50 text-slate-500 border-b border-white/5 font-semibold">
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-3 w-32 text-right">Kts</th>
            ...
            <div className="flex justify-end mt-4">
                <div className="bg-[#16181d]/80 rounded-2xl border border-white/5 shadow-2xl p-6 backdrop-blur-md min-w-[300px]">
                    <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-slate-400">Total Transaksi</span>
