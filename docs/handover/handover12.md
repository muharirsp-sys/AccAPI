...
## 1. WAJIB DIJALANKAN DI PRODUKSI
...
INSERT INTO group_permission (id, group_id, permission_key)
SELECT gen_random_uuid(), id, 'insentif_sales.view_all' FROM "group" WHERE name = '<nama grup>';
```
...
### 1.4 Unggah ulang closing Agustus 2026

Masih kosong sejak dihapus 2026-08-27. Aturan tetap: **hapus periode dulu, baru unggah ulang**
kalau periodenya pernah diunggah sebelum perbaikan tanggal 2026-08-27.
