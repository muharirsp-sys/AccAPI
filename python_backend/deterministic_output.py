    ...
    with zipfile.ZipFile(out, "w", zipfile.ZIP_DEFLATED) as z:
        for name in sorted(src.namelist()):  # urutan entry stabil
            ...
            if name == "docProps/core.xml":
                ...
                #
                # PERBAIKAN INI PERNAH HILANG. Ia dibuat 21 Juli 2026 (0108690) di cabang
                # `feat/urc-deterministic-matcher` dan tidak pernah sampai ke `main`, jadi SETIAP
                # Dataset Excel yang pernah dihasilkan produksi punya `docProps/core.xml` rusak:
                # tag `<dcterms:created ...>2000-...` menjadi `P20-...`, dan berkasnya tidak bisa
                # dibuka. Tidak ada yang tahu selama hampir dua bulan karena satu-satunya uji yang
                # benar-benar MEMBUAT berkas itu (`test_e2e_live`) sudah mati, dan tidak ada alur
                # CI yang menjalankan uji sama sekali. Byte-identik bukan berarti valid.
