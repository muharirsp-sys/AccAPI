...
# ======================================================================================
# ARSIP KOREKSI MANUAL (tombol Laporkan Salah di grid): report_correction menulis
# before->after ke parse_corrections.jsonl. Dulu disuntikkan ke prompt parse_pdf_ai; jalur
# prompt itu sudah mati sejak OCR pindah ke Mistral, jadi pembacanya ikut dihapus.
# ======================================================================================
